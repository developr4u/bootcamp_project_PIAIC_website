...
import Logo from '../images/twitter_logo.png'
import Logo1 from '../images/fb_logo.png'
...
const President = () =>{
    return(
        <Layout>
            ...
            <div><Link to='https://www.web.facebook.com/Dr.ArifAlvi/?_rdc=1&_rdr'><img src={Logo1} width='25px'/> </Link> 
            <Link to='https://www.twitter.com/ArifAlvi'><img src={Logo} width='50px'/> </Link> </div>
        
        
            <p>Dr. Arif Alvi was sworn in as the 13th President of Islamic Republic of Pakistan on 9th September 2018.
